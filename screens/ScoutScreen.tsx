    ...
    <div className="h-full bg-slate-50 overflow-y-auto no-scrollbar pb-32">
      <header className="px-8 pt-12 pb-16 bg-secondary relative overflow-hidden sticky top-0 z-40">
        ...
        <div className="relative z-10 text-center animate-slide-up">
          ...
          <p className="text-white/40 text-[10px] font-black uppercase tracking-[0.3em]">Temporada Atual • Hall of Fame</p>
        </div>
      </header>
      ...
      <div className="px-6 py-10 space-y-5">
        {filteredPlayers.length === 0 ? (
          <div className="py-24 text-center text-slate-300 text-[11px] font-black uppercase tracking-widest italic animate-fade-in">Aguardando estatísticas</div>
        ) : (
              ...
              >
                <div className="flex items-center gap-5">
                   <div className="relative shrink-0">
                     <div className="size-20 rounded-[1.8rem] overflow-hidden border-4 border-slate-50 p-1 bg-slate-100 transition-all group-hover:border-primary">
                   ...
                   <div className="flex flex-col min-w-0">
                     <h4 className="text-[17px] font-black text-secondary uppercase italic tracking-tighter group-hover:text-primary truncate mb-2">{player.name}</h4>
